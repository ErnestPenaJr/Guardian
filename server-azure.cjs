// Azure-compatible CommonJS server entry point
const express = require('express');
const path = require('path');

console.log('=== GUARDIAN SERVER STARTING (Azure CJS) ===');
...
// Import and initialize the ES module parts dynamically
async function initializeServer() {
  try {
    ...
    console.log('✅ Successfully imported ES modules');
