...
app.get('/api/requests', passport.authenticate('jwt', { session: false }), async (req: any, res) => {
  try {
...
app.post('/api/requests', passport.authenticate('jwt', { session: false }), async (req: any, res) => {
  try {
