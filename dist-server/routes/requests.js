...
const VALID_REQUEST_STATUS = ['R', 'H', 'X', 'I', 'D', 'A', 'P'];
    ...
    try {
        ...
        if (req.user) {
            ...
            return {
                ...
                companyId: user.COMPANY_ID || user.company?.id || defaults.companyId,
...
router.get('/', async (req, res) => {
    try {
        ...
        if (status && VALID_REQUEST_STATUS.includes(String(status))) {
