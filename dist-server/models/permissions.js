...
(function (ResourceType) {
    ...
    ResourceType["SYSTEM_SETTINGS"] = "system_settings";
...
export function hasPermission(userPermissions, permissionType, resourceType) {
    const permission = PERMISSIONS.find(p => p.type === permissionType && p.resource === resourceType);
    if (!permission) {
        return false;
    }
