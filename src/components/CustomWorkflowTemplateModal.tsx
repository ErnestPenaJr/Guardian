...
const CustomWorkflowTemplateModal: React.FC<CustomWorkflowTemplateModalProps> = ({
  ...
  return (
    <Modal 
      ...
      title={showFieldBuilder ? "Template Builder" : "Custom Workflow Templates"} 
      size={showFieldBuilder ? "full" : "xl"}
    >
      <div className="min-h-[70vh] bg-gray-50">
        {showFieldBuilder ? (
          <div className="h-full flex flex-col">
            {/* Enhanced Field Builder Header */}
            <div className="bg-white border-b border-gray-200 px-6 py-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                {/* Left side - Navigation and title */}
                <div className="flex items-center space-x-4">
                  <button 
                    className="flex items-center px-3 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200"
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        {editingTemplate ? editingTemplate.FORM_NAME : formData.name || 'New Template'}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <button 
                  className={`flex items-center px-4 py-2 text-sm font-medium text-white rounded-lg transition-all duration-200 ${
                    formData.name.trim() 
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 h-full">
                <div className="px-6 py-4 border-b border-gray-200">
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Design your template by adding, configuring, and organizing form fields
                  </p>
                </div>
