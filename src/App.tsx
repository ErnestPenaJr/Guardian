      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <Router>
          <Routes>
            ...
            />
            <Route
              path="/admin-fields/lookups/:fieldId"
              element={
                <ProtectedRoute>
            ...
            />
            <Route
              path="/admin-forms-groups/fields/:groupId"
              element={
                <ProtectedRoute>
            ...
            */}
            ...
            />
            <Route
              path="/my-notices/notification-status-dashboard"
              element={
                <ProtectedRoute>
                  <Home />
                </ProtectedRoute>
            ...
            />
            <Route
              path="/my-notices/view-notice/:id"
              element={
                <ProtectedRoute>
                  <Home />
                </ProtectedRoute>
