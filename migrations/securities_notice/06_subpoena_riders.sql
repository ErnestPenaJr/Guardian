...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_SR_LANG_TEMPLATE')
    ALTER TABLE [GUARDIAN].[SUBPOENA_RIDERS]
    ADD CONSTRAINT [FK_SR_LANG_TEMPLATE] FOREIGN KEY ([LANGUAGE_TEMPLATE_ID])
        REFERENCES [GUARDIAN].[SUBPOENA_LANGUAGE_TEMPLATES] ([LANGUAGE_TEMPLATE_ID]);
